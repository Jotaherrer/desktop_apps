...
precio_fijos = ttk.Label(my_frame1, text='Costo total').place(x=590, y=25)
obser_fijos = ttk.Label(my_frame1, text='Observación a realizar').place(x=680, y=25)
