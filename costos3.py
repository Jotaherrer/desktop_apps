...
precio2 = ttk.Label(my_frame1, text='Precio por unidad').place(x=1150,y=25)
total = ttk.Label(my_frame1, text='Costo total').place(x=345,y=25)
total = ttk.Label(my_frame1, text='Costo total').place(x=810,y=25)
total = ttk.Label(my_frame1, text='Costo total').place(x=1275,y=25)
...
label_otros2 = Label(my_frame1, text='OTROS 2:')
